...
class BillTypePolicy
{
    ...
    {
        return $user->can('view_any_bill::type');
    }
    ...
    {
        return $user->can('view_bill::type');
    }
    ...
    {
        return $user->can('create_bill::type');
    }
    ...
    {
        return $user->can('update_bill::type');
    }
    ...
    {
        return $user->can('delete_bill::type');
    }
    ...
    {
        return $user->can('delete_any_bill::type');
    }
    ...
    {
        return $user->can('force_delete_bill::type');
    }
    ...
    {
        return $user->can('force_delete_any_bill::type');
    }
    ...
    {
        return $user->can('restore_bill::type');
    }
    ...
    {
        return $user->can('restore_any_bill::type');
    }
