...
Route::get('mails/{mail}/preview', MailPreviewController::class)->name('filament.admin.mails.preview');
Route::get('mails/{mail}/attachment/{attachment}/{filename}', MailDownloadController::class)->name('filament.admin.mails.attachment.download');
